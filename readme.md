...
<span style="font-family:Arial sans-serif;font-size:16px;">WM Password</span>

  
<span style="font-family:Arial sans-serif;font-size:14px;">Web sites, bank accounts, ... passwords are everywhere in out life. With WM Password, no need to store all the passwords of your different accounts. The application stores all your passwords in a secure way. WM Password can also generate secure passwords for you.</span>
